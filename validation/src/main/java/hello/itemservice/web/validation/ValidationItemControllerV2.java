...
public class ValidationItemControllerV2 {
    ...
    public String addItemV1(@ModelAttribute Item item, BindingResult bindingResult,
        ...
        if (item.getPrice() != null && item.getQuantity() != null) {
            ...
            if (result < 10000) {
                bindingResult.addError(new ObjectError("item", "가격 * 수의 합은 10,000원 이상이어야 합니다. 현재 값 = " + result));
            }
        }
    ...
    public String addItemV2(@ModelAttribute Item item, BindingResult bindingResult,
        ...
        if (item.getPrice() != null && item.getQuantity() != null) {
            ...
            if (result < 10000) {
                bindingResult.addError(
                    new ObjectError("item", null, null, "가격 * 수의 합은 10,000원 이상이어야 합니다. 현재 값 = " + result));
            }
        }
    ...
    public String addItemV3(@ModelAttribute Item item, BindingResult bindingResult,
        ...
        if (item.getPrice() == null || item.getPrice() < 1000 || item.getPrice() > 1000000) {
            bindingResult.addError(new FieldError("item", "price", item.getPrice(), false,
                new String[]{"range.item.price", "required.default"}, new Object[]{1000, 1000000}, null));
        }
        ...
        if (item.getPrice() != null && item.getQuantity() != null) {
            ...
            if (result < 10000) {
                bindingResult.addError(
                    new ObjectError("item", new String[]{"totalPriceMin"}, new Object[]{10000, result}, null));
            }
        }
